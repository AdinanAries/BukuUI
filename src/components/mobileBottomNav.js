    ...
    return (
        <><div id="mobile_bottom_nav">
            <div style={{padding: "5px", display: "flex", flexDirection: "row !important", justifyContent: "space-between"}}>
                <div className="active main_menu_item" onClick={refreshPageFunc} style={{display: "flex", flexDirection: "column", justifyContent: "center", width: "calc(25% - 2px)"}}>
                ...
                <div className="main_menu_item" id="main_menu_all_services_option" onClick={toggle_show_all_service} style={{display: "flex", flexDirection: "column", justifyContent: "center", width: "calc(25% - 2px)"}}>
                ...
                <div className="main_menu_item" id="main_menu_notifications_option" onClick={toggle_show_notifications_container} style={{display: "flex", flexDirection: "column", justifyContent: "center", width: "calc(25% - 2px)", position: "relative"}}>
                ...
                <div className="main_menu_item" id="main_menu_appointments_option" onClick={()=>{hide_all_popups("main_menu_appointments_option")}} style={{display: "flex", flexDirection: "column", justifyContent: "center", width: "calc(25% - 2px)"}}>
                ...
                <div  className="main_menu_item" id="main_menu_account_option" onClick={()=>{hide_all_popups("main_menu_account_option")}} style={{display: "flex", flexDirection: "column", justifyContent: "center", width: "calc(25% - 2px)"}}>
